package net.bobby68.titan.block;

import net.bobby68.titan.TutorialMod;
import net.bobby68.titan.world.tree.RedMapleSaplingGenerator;
...
public class ModBlocks {
    ...
    public static final Block NETHERRACK_STEEL_ORE = registerBlock("netherrack_steel_ore",
            new ExperienceDroppingBlock(FabricBlockSettings.copyOf(Blocks.DEEPSLATE).strength(4.0f).requiresTool(),
                    UniformIntProvider.create(2, 6)));
    ...
    public static final Block REFUEL_STATION = registerBlock("refuel_station",
            new Block(FabricBlockSettings.copyOf(Blocks.SMITHING_TABLE).strength(4.0f).requiresTool()));

    public static final Block GEAR_STATION = registerBlock("gear_station",
            new Block(FabricBlockSettings.copyOf(Blocks.SMITHING_TABLE).strength(4.0f).requiresTool()));
